 ...
 * @author MohamadEsa
 */
public class Control_listProviderProduk {
  listProviderProduk v;
  transaksiPanel view;
  DAO_Provider impl;
  DAO_Transaksi impl2;
  List<Provider> li;
  
  public Control_listProviderProduk(listProviderProduk v){
    this.v=v;
...
//     System.out.println("Cek "+data);
    ...
    public void search(listProviderProduk data, String data2){

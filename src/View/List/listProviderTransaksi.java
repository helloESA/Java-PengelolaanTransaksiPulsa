...
import Controller.List.Control_listProviderTransaksi;
 ...
 * @author MohamadEsa
 */
public class listProviderTransaksi extends javax.swing.JDialog implements Config{
  ...
  Control_listProviderTransaksi c;
  
  public listProviderTransaksi(inputTransaksi view){
    initComponents();
    this.setTitle(listProvider);
    this.setAlwaysOnTop(true);
    this.view=view;
    this.setLocationRelativeTo(view);
    c = new Control_listProviderTransaksi(this);
    c.isiTableFromKategori(view.getTxtKategori().getText());
  }
  ...
  private void txtCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariKeyPressed
    c.search(this, view.getTxtKategori().getText());
